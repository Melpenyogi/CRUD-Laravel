...
<head>
    ...
    <link rel="shortcut icon" src="{{ asset('lte/dist/img/icon.png') }}" type="image/x-icon">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('dashboard')}}" class="brand-link">
                <img src="{{ asset('lte/dist/img/user1-128x128.jpg') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light"><strong> Admin CRUD</strong></span>
            </a>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('index') }}" class="nav-link">
                                ...
                                <p> Users<span class="right badge badge-danger"></span></p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('index') }}" class="nav-link">
                                ...
                                <p> Book<span class="right badge badge-danger"></span></p>
                            </a>
                        </li>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2014 <a href="www.sacode.web.id">Developed</a> By.</strong>
            Melpen
